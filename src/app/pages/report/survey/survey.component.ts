...
export class SurveyComponent implements AfterViewInit{
  ...
  public chartItems = [
    { label: 'Pendiente', color: '#FF9A57', value: 2 },
    { label: 'Completadas', color: '#6BE39C', value: 9 },
  ];
  ...
  loadChartData() {
    this.barChartData = {
      labels: ['Completamente satisfecho', 'Insatisfecho', 'Satisfecho', 'Completamente satisfecho'],
      datasets: [
        {
          label: 'Porcentaje %',
